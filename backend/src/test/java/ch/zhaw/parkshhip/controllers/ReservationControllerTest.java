...
public class ReservationControllerTest {
	...
	public void getReservationByIdTest() throws Exception {
		...
		mockMvc.perform(get("/reservation/{id}", 1L)).andExpect(status().isOk()).andExpect(jsonPath("$.id").value(1L));
	...
	public void getAllReservationsTest() throws Exception {
		...
		mockMvc.perform(get("/reservation")).andExpect(status().isOk()).andExpect(jsonPath("$.[0].id").value(1L))
	...
	public void updateReservationTest() throws Exception {
		...
		mockMvc.perform(put("/reservation/{id}", 1L).contentType(MediaType.APPLICATION_JSON)
	...
	public void deleteReservationTest() throws Exception {
		...
		mockMvc.perform(delete("/reservation/{id}", 1L)).andExpect(status().isNoContent());
