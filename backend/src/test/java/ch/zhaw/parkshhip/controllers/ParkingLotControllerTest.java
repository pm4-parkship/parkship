...
public class ParkingLotControllerTest {
	...
	public void getParkingLotByIdTest() throws Exception {
		...
		mockMvc.perform(get("/parking-lot/{id}", 1L)).andExpect(status().isOk()).andExpect(jsonPath("$.id").value(1L));
	...
	public void getAllParkingLotsTest() throws Exception {
		...
		mockMvc.perform(get("/parking-lot")).andExpect(status().isOk()).andExpect(jsonPath("$.[0].id").value(1L))
	...
	public void updateParkingLotTest() throws Exception {
		...
		mockMvc.perform(put("/parking-lot/{id}", 1L).contentType(MediaType.APPLICATION_JSON)
	...
	public void deleteParkingLotTest() throws Exception {
		...
		mockMvc.perform(delete("/parking-lot/{id}", 1L)).andExpect(status().isNoContent());
	...
	public void getParkingLotNotFoundTest() throws Exception {
	    ...
	    mockMvc.perform(get("/parking-lot/{id}", 1L))
	...
	public void deleteParkingLotNotFoundTest() throws Exception {
	    ...
	    mockMvc.perform(delete("/parking-lot/{id}", 1L))
	            .andExpect(status().isNotFound());
