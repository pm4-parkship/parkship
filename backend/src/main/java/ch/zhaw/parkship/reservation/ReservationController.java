...
public class ReservationController {
     ...
     * @return ResponseEntity<ReservationDto> Returns the saved reservation data in
     ...
     * @return ResponseEntity<ReservationDto> Returns the reservation data in the
     ...
     *
     * @return ResponseEntity<List<ReservationDto>> Returns a list of reservation
    ...
    /**
     *
     * This end-point updates a reservation with the provided id and reservation
     * data.
     *
     * @param id             The id of the reservation to be updated.
     * @param reservationDto The reservation data to be updated.
     * @return ResponseEntity<ReservationDto> Returns the updated reservation data
     *         in the HTTP response body with a status code of 200 if updated
