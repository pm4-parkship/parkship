...
public class ReservationService {
     ...
     * @return Optional<ReservationDto> Returns an Optional object containing the
     *         saved reservation data if created successfully, otherwise returns an
    ...
    /**
     *
     * This method creates a new reservation with the provided parking lot id and
     * reservation data.
     *
     * @param parkingLotId The id of the parking lot where the reservation will be
     *                     created.
     * @param data         The reservation data to be saved.
     * @return Optional<ReservationDto> Returns an Optional object containing the
     *         saved reservation data if created successfully, otherwise returns an
     *         empty Optional object.
     */
    public Optional<ReservationDto> create(int parkingLotId, ReservationDto data) {
     ...
     * @return Optional<ReservationDto> Returns an Optional object containing the
     *         reservation data in the ReservationDto format if found, otherwise
     *         returns an empty Optional object.
     */
    public Optional<ReservationDto> getById(int id) {
     ...
     *
     * @return List<ReservationDto> Returns a list of reservation data in the
     *         ReservationDto format in the HTTP response body with a status code of
     *         200 if found, otherwise returns a no content status code.
     */
     ...
     * @return Optional<ReservationDto> Returns an Optional object containing the
     *         updated reservation data in the ReservationDto format if updated
     *         successfully, otherwise returns an empty Optional object.
     */
     ...
     * @return Optional<ReservationDto> Returns an Optional object containing the
     *         deleted reservation data in the ReservationDto format if deleted
     *         successfully, otherwise returns an empty Optional object.
     */
    @Transactional
    public Optional<ReservationDto> deleteById(int id) {
