...
public class ParkingLotDto implements Serializable {
    ...
    public String toString() {
        return "ParkingLotDto{" + "id=" + id + ", owner=" + owner + ", description='" + description + '\'' + ", tags="
                + tags + ", longitude=" + longitude + ", latitude=" + latitude + ", address='" + address + '\''
                + ", addressNr='" + addressNr + '\'' + ", floor=" + floor + ", nr='" + nr + '\'' + ", price=" + price
                + ", state='" + state + '\'' + '}';
    }
