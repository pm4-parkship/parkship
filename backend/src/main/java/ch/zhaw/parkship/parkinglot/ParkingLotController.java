...
public class ParkingLotController {
     ...
     * @return ResponseEntity<ParkingLotDto> Returns the saved parking lot data in
     *         the HTTP response body with a status code of 201 if created
     *         successfully, otherwise returns a bad request status code.
     */
     ...
     * @return ResponseEntity<ParkingLotDto> Returns the parking lot data in the
     *         HTTP response body with a status code of 200 if found, otherwise
     *         returns a not found status code.
     */
    @GetMapping(value = "/{id}", produces = "application/json")
    public ResponseEntity<ParkingLotDto> getParkingLotById(@PathVariable int id) {
     ...
     *
     * @return ResponseEntity<List<ParkingLotDto>> Returns a list of parking lot
     *         data in the HTTP response body with a status code of 200 if found,
     *         otherwise returns a no content status code.
     */
    ...
    /**
     *
     * This end-point updates a parking lot with the provided id and parking lot
     * data.
     *
     * @param id            The id of the parking lot to be updated.
     * @param parkingLotDto The parking lot data to be updated.
     * @return ResponseEntity<ParkingLotDto> Returns the updated parking lot data in
     *         the HTTP response body with a status code of 200 if updated
     *         successfully, otherwise returns a not found status code.
     */
    @PutMapping(value = "/{id}", consumes = "application/json", produces = "application/json")
    public ResponseEntity<ParkingLotDto> updateParkingLot(@PathVariable int id,
     ...
     * @return ResponseEntity<Void> Returns a no content status code if deleted
     *         successfully, otherwise returns a not found status code.
     */
