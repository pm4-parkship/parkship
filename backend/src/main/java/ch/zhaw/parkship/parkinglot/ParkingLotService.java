 ...
 *
 * It performs CRUD operations on ParkingLotEntity objects through
 * ParkingLotRepository and UserRepository.
 */
@Service
@Transactional
public class ParkingLotService {
     ...
     * @return Optional<ParkingLotDto> Returns an Optional object containing the
     *         saved parking lot data in the ParkingLotDto format if created
     ...
     * @return Optional<ParkingLotDto> Returns an Optional object containing the
     *         parking lot data in the ParkingLotDto format if found, otherwise
     *         returns an empty Optional object.
     */
    public Optional<ParkingLotDto> getById(int id) {
     ...
     *
     * @return List<ParkingLotDto> Returns a list of parking lot data in the
     *         ParkingLotDto format in the HTTP response body with a status code of
     ...
     * @return Optional<ParkingLotDto> Returns an Optional object containing the
     *         updated parking lot data in the ParkingLotDto format if updated
     *         successfully, otherwise returns an empty Optional object.
     */
     ...
     * @return Optional<ParkingLotDto> Returns an Optional object containing the
     *         deleted parking lot data in the ParkingLotDto format if deleted
     *         successfully, otherwise returns an empty Optional object.
     */
    public Optional<ParkingLotDto> deleteById(int id) {
