...
const SearchBar = (props: { fetchParkspace: (arg: SearchParameters) => void }) => {
    ...
    >
        ...
        <Grid item md={10}>
            <TagBar options={dummyTags} addTag={addTag} handleDelete={handleDelete} selected={selectedTags}></TagBar>
        </Grid>
    </Grid>;
};
